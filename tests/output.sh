...
zsh compare.sh <(ls -lfFTisn / 2>&1) <(./uls -lfFTisn / 2>&1) "-lfFTisn /"
zsh compare.sh <(ls -lfFTisg / 2>&1) <(./uls -lfFTisg / 2>&1) "-lfFTisg /"
zsh compare.sh <(ls -lfFTiso / 2>&1) <(./uls -lfFTiso / 2>&1) "-lfFTiso /"
zsh compare.sh <(ls -lfFTisng / 2>&1) <(./uls -lfFTisng / 2>&1) "-lfFTisng /"
...
zsh compare.sh <(ls -gno 2>&1) <(./uls -gno 2>&1) "-n"
zsh compare.sh <(ls -gno 2>&1) <(./uls -gno 2>&1) "-g"
zsh compare.sh <(ls -gno 2>&1) <(./uls -gno 2>&1) "-o"

zsh compare.sh <(ls -gn 2>&1) <(./uls -gn 2>&1) "-gn"
zsh compare.sh <(ls -ng 2>&1) <(./uls -ng 2>&1) "-ng"
zsh compare.sh <(ls -go 2>&1) <(./uls -go 2>&1) "-go"
zsh compare.sh <(ls -og 2>&1) <(./uls -og 2>&1) "-og"
zsh compare.sh <(ls -no 2>&1) <(./uls -no 2>&1) "-no"
zsh compare.sh <(ls -on 2>&1) <(./uls -on 2>&1) "-on"

zsh compare.sh <(ls -gno 2>&1) <(./uls -gno 2>&1) "-gno"
zsh compare.sh <(ls -ngo 2>&1) <(./uls -ngo 2>&1) "-ngo"
zsh compare.sh <(ls -gon 2>&1) <(./uls -gon 2>&1) "-gon"
zsh compare.sh <(ls -nog 2>&1) <(./uls -nog 2>&1) "-nog"
zsh compare.sh <(ls -ogn 2>&1) <(./uls -ogn 2>&1) "-ogn"
zsh compare.sh <(ls -ong 2>&1) <(./uls -ong 2>&1) "-ong"
